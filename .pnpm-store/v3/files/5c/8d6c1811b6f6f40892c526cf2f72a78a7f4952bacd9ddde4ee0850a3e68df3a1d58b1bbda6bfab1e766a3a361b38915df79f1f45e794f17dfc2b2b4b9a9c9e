...
function isPropertyDefinition(node) {
    return node.type === experimentalUtils.AST_NODE_TYPES.PropertyDefinition;
}
...
function isForStatement(node) {
    return node.type === experimentalUtils.AST_NODE_TYPES.ForStatement;
}
...
function isObjectExpression(node) {
    return node.type === experimentalUtils.AST_NODE_TYPES.ObjectExpression;
}
...
function createRule(name, meta, defaultOptions, ruleFunctionsMap) {
    return experimentalUtils.ESLintUtils.RuleCreator((name) => `https://github.com/jonaskello/eslint-plugin-functional/blob/v4.2.0/docs/rules/${name}.md`)({
        name,
        meta,
...
const schema$f = [
    deepmergeTs.deepmerge(ignorePatternOptionSchema, {
        type: "object",
        properties: {
            allowRestParameter: {
                type: "boolean",
...
const schema$e = [
    deepmergeTs.deepmerge(ignorePatternOptionSchema, ignoreAccessorPatternOptionSchema, ignoreClassOptionSchema, {
        type: "object",
        properties: {
...
const name$a = "no-let";
const schema$a = [
    deepmergeTs.deepmerge(allowLocalMutationOptionSchema, ignorePatternOptionSchema, {
        type: "object",
        properties: {
            allowInForLoopInit: {
                type: "boolean",
...
const schema$1 = [
    deepmergeTs.deepmerge(allowLocalMutationOptionSchema, ignorePatternOptionSchema, ignoreClassOptionSchema, ignoreInterfaceOptionSchema, {
        type: "object",
        properties: {
